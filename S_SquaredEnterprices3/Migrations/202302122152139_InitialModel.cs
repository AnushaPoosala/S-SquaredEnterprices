namespace S_SquaredEnterprices3.Migrations
{
    ...
    public partial class InitialModel : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        FirstName = c.String(),
                        LastName = c.String(),
                        EmployeeRoleId = c.Byte(nullable: false),
                        ManagerFirstName = c.String(),
                        ManagerLasttName = c.String(),
                        ManagerEmployeeId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.EmployeeId)
                .ForeignKey("dbo.Roles", t => t.EmployeeRoleId, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Employees", "EmployeeRoleId", "dbo.Roles");
